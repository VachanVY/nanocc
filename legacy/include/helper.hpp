...
inline std::unique_ptr<IRProgramNode>
generateIR(std::unique_ptr<ProgramNode>& ast, bool debug) {
...
inline void correctAsmInstructions(std::unique_ptr<AsmProgramNode>& asm_ast,
                                   bool debug) {
...
generateAsm(std::unique_ptr<AsmProgramNode>& asm_ast) {
