...
void declarationNodeResolveTypes(std::unique_ptr<DeclarationNode> &,
                                 IdentifierMap &);
void variableDeclNodeFileScopeResolveType(std::unique_ptr<VariableDeclNode> &,
                                          IdentifierMap &);
void variableDeclNodeBlockScopeResolveTypes(std::unique_ptr<VariableDeclNode> &,
                                            IdentifierMap &);
void functionDeclNodeResolveTypes(std::unique_ptr<FunctionDeclNode> &,
                                  IdentifierMap &);
void blockNodeResolveTypes(std::unique_ptr<BlockNode> &, IdentifierMap &);
void blockItemNodeResolveTypes(const std::unique_ptr<BlockItemNode> &,
                               IdentifierMap &);
void statementNodeResolveTypes(std::unique_ptr<StatementNode> &,
                               IdentifierMap &);
void returnNodeResolveTypes(std::unique_ptr<ReturnNode> &, IdentifierMap &);
void expressionNodeResolveTypes(std::unique_ptr<ExpressionNode> &,
                                IdentifierMap &);
...
void exprFactorNodeResolveTypes(std::unique_ptr<ExprFactorNode> &,
                                IdentifierMap &);
...
void assignmentNodeResolveTypes(std::unique_ptr<AssignmentNode> &,
                                IdentifierMap &);
void conditionalNodeResolveTypes(std::unique_ptr<ConditionalNode> &,
                                 IdentifierMap &);
void functionCallNodeResolveTypes(std::unique_ptr<FunctionCallNode> &,
                                  IdentifierMap &);
...
void programNodeLoopLabelling(std::unique_ptr<ProgramNode> &program_node,
                              std::string &loop_label);
void declarationNodeLoopLabelling(
    std::unique_ptr<DeclarationNode> &declaration_node,
    std::string &loop_label);
void variableDeclNodeLoopLabelling(
    std::unique_ptr<VariableDeclNode> &variable_decl_node,
    std::string &loop_label);
void functionDeclNodeLoopLabelling(
    std::unique_ptr<FunctionDeclNode> &function_decl_node,
    std::string &loop_label);
void blockNodeLoopLabelling(std::unique_ptr<BlockNode> &block_node,
                            std::string &loop_label);
void blockItemNodeLoopLabelling(
    const std::unique_ptr<BlockItemNode> &block_item_node,
    std::string &loop_label);
...
void returnNodeLoopLabelling(std::unique_ptr<ReturnNode> &return_node,
                             std::string &loop_label);
void expressionNodeLoopLabelling(
    std::unique_ptr<ExpressionNode> &expression_node, std::string &loop_label);
void ifElseNodeLoopLabelling(std::unique_ptr<IfElseNode> &ifelse_node,
                             std::string &loop_label);
...
void continueNodeLoopLabelling(std::unique_ptr<ContinueNode> &continue_node,
                               std::string &loop_label);
void whileNodeLoopLabelling(std::unique_ptr<WhileNode> &while_node,
                            std::string &loop_label);
void doWhileNodeLoopLabelling(std::unique_ptr<DoWhileNode> &dowhile_node,
                              std::string &loop_label);
void forNodeLoopLabelling(std::unique_ptr<ForNode> &for_node,
                          std::string &loop_label);
