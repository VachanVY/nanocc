...
void functionCallNodeIRDump(IRFunctionCallNode* func_call_node, int indent) {
    printIndent(indent);
    std::print("{} = {}(", valNodeIRDump(func_call_node->return_dest), func_call_node->func_name);
...
void instructionNodeIRDump(std::unique_ptr<IRInstructionNode>& instr_node, int indent) {
